...
public class MovieDetailsHorizontal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_movie_details_hirozontal);
        ...
        playButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(MovieDetailsHorizontal.this, VideoPlayerActivity.class);
